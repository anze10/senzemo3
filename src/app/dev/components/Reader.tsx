        ...
        <Box className="px-6 py-8 md:px-8 md:py-12">
          ...
          <Box
            style={{
              ...
              backgroundColor: getStatusColor(current_sensor?.data.common_data[1]?.value as number),
              padding: "10px",
              borderRadius: "8px",
              marginBottom: "20px",
              width: "100%",
            ...
            <Box className="mt-4">
              ...
              <Box className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <Box style={{ display: "flex", alignItems: "center" }}>
                  <Checkbox
                    {...register("adc-enable")}
                    checked={convertoToBoolean(current_sensor?.data.common_data[1]?.value)}
                  />
